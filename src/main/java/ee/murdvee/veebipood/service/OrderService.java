...
import ee.murdvee.veebipood.dto.EveryPayBody;
import ee.murdvee.veebipood.dto.EveryPayResponse;
...
public class OrderService {
    ...
    public PaymentUrl makePayment(Long orderId, double sum) {
        ...
        body.setOrder_reference("murdvee" + orderId); // kui on makstud, siis teist korda maksma minna ei saa
